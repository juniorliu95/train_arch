...
#        model_path = '../model/vgg_16'
    ...
    try:
        for i in range(0, nBatchs):
            ...
            train_logits, label_out, _, cur_loss, cur_train_eval, summary = sess.run([logits,label_batch, train_op, loss, accuracy,summary_op_train],
                                                            feed_dict={handle: handle_train, is_training:True, k_prob: keep_prob} )
            print train_logits, label_out
